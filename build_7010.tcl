...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_7010/src"] [file normalize "$origin_dir/ip_7010/ip_repo"] [file normalize "$origin_dir/ip_7010/elink-gold"]" $obj
