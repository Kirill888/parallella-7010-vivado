...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_7020/src"] [file normalize "$origin_dir/ip_7020/ip_repo"] [file normalize "$origin_dir/ip_7020/elink-gold"]" $obj
